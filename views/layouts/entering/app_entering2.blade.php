...
<div class="container-fluid">
        ...
        <div class="col-12" style="height: 100%">
            <div class="bg-dark" style="width: 100%;height:95%;margin-top: 3px;border-radius: 5px">
                <div class="row justify-content-center" style="height: 70%">
                    <div class="col-2"><img src="{{URL::to('/')}}/mapna.jpg" class="rounded-circle mt-0 ml-3" alt="Cinque Terre"></div>
                    <div class="col-1">.</div>
                    <div class="col-1">.</div>
                    <div class="col-1">.</div>
                    ...
                    <div class="col-2 pt-1"><img src="{{URL::to('/')}}/requester001.png" class="rounded-circle" style="width:30%;height:50%"></div>
                </div>
            </div>
        </div>
    </div>
                       ...
                       <div class="col">
                           <div class="row"  >
                               <div class="col">
                                   <div >
                                       <a href="#">
                                           <img src="{{URL::to('/')}}/eq1.png" id="bs5"  class="reza2" data-toggle="tooltip" data-placement="bottom" title="در این مرحله می توان لیست کلیه وسایل کار این نفرات را وارد کرد">
                                       </a>
                                   </div>
                               </div>
                           </div>
                       ...
                       <div class="col">
                           <div class="row">
                               <div class="col">
                                   <div>
                                       <a href="#">
                                           <img src="{{URL::to('/')}}/electronic1.png" id="bs4"  class="reza2" data-toggle="tooltip" data-placement="bottom" title="در این مرحله می توان لیست تجهیزات الکترونیکی که این افراد با خود وارد نیروگاه می کنند وارد کرد">
                                       </a>
                                   </div>
                               </div>
                           </div>
                       ...
                       <div class="col">
                           <div class="row">
                               <div class="col">
                                   <div>
                                       <a href="#">
                                           <img src="{{URL::to('/')}}/car1.png" id="bs3"  class="reza2" data-toggle="tooltip" data-placement="bottom" title="در این مرحله می توانید مشخصات خودرو یا خودروهایی که این افراد وارد نیروگاه می کنند وارد نمایید">
                                       </a>
                                   </div>
                               </div>
                           </div>
                       ...
                       <div class="col">
                           <div class="row">
                               <div class="col">
                                   <div>
                                       <a href="#">
                                           <img src="{{URL::to('/')}}/user_add02.png" id="bs2"  class="reza2" data-toggle="tooltip" data-placement="bottom" title="در این مرحله می توانید اسامی افرادی که برای آنها درخواست مجوز کرده اید همراه با ساعت و تاریخ حضور وارد نمایید">
                                       </a>
                                   </div>
                               </div>
                           </div>
                       ...
                       <div class="col">
                           <div class="row">
                               <div class="col">
                                   <div>
                                       <a href="#">
                                           <img src="{{URL::to('/')}}/start01.png" id="bs1"  class="reza2" data-toggle="tooltip" data-placement="bottom" title="در این مرحله می توانید فرم جدیدی برای درخواست مجوز خروج و یا ورود افراد همراه با عنوان فعالیت و شرکت مربوطه ایجاد کنید">
                                       </a>
                                   </div>
                               </div>
                           </div>
    ...
    <div class="row mt-5" style="height: 83%;">
        <div class="col">
