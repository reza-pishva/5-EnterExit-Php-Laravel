...
@endsection
@section("content2")
    <div id="s2_1" class="container" style="margin: auto;background-color:rgba(253, 253, 254, 0.4);width: 100%;border-radius: 5px;height:250px;direction: rtl;color: white;margin-top: 60px;padding-top: 2px;display: none;overflow-y: scroll">
