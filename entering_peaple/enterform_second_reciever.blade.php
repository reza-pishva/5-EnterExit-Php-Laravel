...
@section('content')
    <script>
        $(document).ready(function(){
            bootstrap.Toast.Default.delay = 10
            ...
            $('#daftarsearach').click(function(event) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        var time_enter = ''
                        var row = ''
                        var row_th ='<tr class="bg-info report_row" style="color: white;height: 30px;text-align: center"><td style="border-left:1px white solid;text-align: center">کد تردد</td><td style="border-left:1px white solid;text-align: center">نوع تردد</td><td style="border-left:1px white solid;text-align: center">نام</td><td style="border-left:1px white solid;text-align: center">نام خانوادگی</td><td style="border-left:1px white solid;text-align: center">کد ملی</td><td style="border-left:1px white solid;text-align: center">مراجعه از</td><td style="border-left:1px white solid;text-align: center">تاریخ</td><td style="border-left:1px white solid;text-align: center">ساعت</td><td style="border-left:1px white solid;text-align: center">ثبت کننده</td></tr>'
                        $("#report_table").append(row_th)
                        for(var i = 0; i < response.results.length; i++) {
                            ...
                            for(var z1 = 0; z1 < response.peaples.length; z1++) {
                                for(var z2 = 0; z2 < response.forms.length; z2++){
                                    if(response.forms[z2]['id_ef']==response.peaples[z1]['id_ef']){
                                       company = $('<td style="width:20%;text-align: center;padding-right: 5px">' + response.forms[z2]['company'] + '</td>')
                                       break;
                                    }
                                }                                
                            }
                            ...
                            row = $('<tr class="report_row"></tr>')
                            row.append(i_ed,enter_exit,f_name,l_name,code_melli,company,date_enter,time_enter,l_name2)
                            $("#report_table").append(row)
                        }
                        $("#editlist").css("margin-top","100px");
                        $(".mylist").hide();
    ...
    <!-- Title of report -->
    <div class="row mylist2" style="margin: auto;width:120%;display: none;margin-top: 10px">
        <div class="col-12" id="title_report" style="height: 35px;margin-top: 10px;border-radius: 5px;font-family: Tahoma;font-size: small;direction: rtl;color: white;text-align: right;background-color:rgb(14,53,126);margin-left:-50px"></div>
    </div>
    <!-- content of report -->
    <div class="row mylist2" style="margin: auto;width:120%;height:302px;direction: rtl;margin-top: 4px;border: 1px solid black;border-radius: 5px;display: none;background-color: beige;margin-left:-50px">
